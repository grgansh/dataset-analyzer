...
def main(host: str, port: int):
    ...
    skill = AgentSkill(
        id='dataset_audit',
        name='Dataset Audit',
        description='Analyzes dataset reliability',
        tags=["data", "analysis", "bias", "ml"],
        examples=[
    ...
    agent_card = AgentCard(
        name='dataset-lie-detector',
        description='Detects bias, imbalance, and misleading patterns in datasets',
